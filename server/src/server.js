...
function postStatusUpdate(user, location, contents) {
  ...
  // The new status update. The databse will assign the ID for us.
  var newStatusUpdate = {
    "likeCounter": [],
    "type": "statusUpdate",
    "contents": {
...
// 'POST /feeditems { userId: user, location: location, contents: contents }'
app.post('/feeditem',
        ...
        // Check if requesters is authorized to post this status update.
