...
var app = express();
// Import reverse String from util.js
var util = require('./util');
var reverseString = util.reverseString;
var bodyParser = require('body-parser');
var serverMod = require('./database');
var readDocument = serverMod.readDocument;
...
/**
 * Get the user IF from a token. Returns -1 (an invalid ID)
 *if it fails.
 */
function getUserIdFromToken(authorizationLine) {
  try {
    ...
    var regualrString = new Buffer(token, 'base64').toString('utf8');
